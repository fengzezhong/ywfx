...
// API
	...
	/*	Every input option is tested and parsed. This'll prevent
		...
		object, to make sure all values can be correctly looped elsewhere. */
			...
			$.each( tests, function( name, test ){
				...
				if( ( test['r'] && !isSet ) ||
				// If the migu returns false, fail.
	...
	// Parse options, add classes, attach events, create HTML.
		function create ( options ) {
			...
			// which will be changed by the 'migu' function.
			...
			// Make sure the migu for serialization runs.
			options['serialization'] = options['serialization'] || {};

			// Run all options through a testing mechanism to ensure correct
			// input. The migu function will throw errors, so there is
