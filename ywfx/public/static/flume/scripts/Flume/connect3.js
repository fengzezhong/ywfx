...
FLUME.connect = (function($, _, jsPlumb) {
     ...
     *
     **/
    var saveConfig = function(configname) {
        /**
        ...
        if (typeof(Storage) !== "undefined") {
            ...
            localStorage.setItem(configname, JSON.stringify(FLUME_CONFIG));
        } else {
    ...
    var loadConfig = function(configname) {
        //flumeConfig
        var FLUME_CONFIG = JSON.parse(localStorage.getItem(configname));
